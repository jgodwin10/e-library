...
const Hero = () => {
  return (
    <div
      ...
      className="md:h-[80vh] h-[60vh] bg-[image:var(--image-url)] bg-cover px-3 before:contents-[''] before:w-full before:h-full before:bg-black/60 before:absolute before:top-0 before:left-0 relative flex items-center "
    >
